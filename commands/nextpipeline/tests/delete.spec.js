...
describe('new gen pipeline delete test', () => {

        describe('deletePipeline test', function() {
            ...
            describe('postive', function() {
                ...
                it('Should pass and return the delete context name (when file is provide)', () => {
                    ...
                    return commandsProxy.deletePipeline(info).then((res)=> {
            ...
            describe('negative', function() {
                it('Should fail and return an error (when file is provide)', () => {
                    ...
                    return commandsProxy.deletePipeline(info)
                        .catch((err)=>{
