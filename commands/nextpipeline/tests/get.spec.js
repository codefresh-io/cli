...
describe('new gen pipeline get test', () => {

    describe('getPipelineByName test', function() {
        ...
        describe('postive', function() {
            ...
            it('Should pass and return the name of the context', () => {
                ...
                return commandsProxy.getPipelineByName(info).then((res)=> {
        ...
        describe('negative', function() {
            it('Should failed and return an error', () => {
                ...
                return commandsProxy.getPipelineByName(info)
                    .catch((err)=>{
