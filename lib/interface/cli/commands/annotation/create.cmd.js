...
const command = new Command({
    ...
    builder: yargs => yargs
        ...
        .example('codefresh create annotation image 2dfacdaad466 -l coverage=75%', 'Annotate entity with a single label')
    ...
    handler: async (argv) => {
        ...
        await Logic.setAnnotations({ entityId, entityType, labels });
