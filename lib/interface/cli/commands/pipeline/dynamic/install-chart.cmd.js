...
const install = new Command({
    ...
    cliDocs: {
        ...
        Example:
        Install with absolute URL:
        codefresh install-chart --repository https://kubernetes-charts.storage.googleapis.com --cluster production --chart mongodb --version 0.4.24
        Install with helm repo saved in Codefresh:
        Find all repos: codefresh get ctx --type helm-repository
        codefresh install-chart --repository MY_CONTEXT_NAME --cluster production --chart mongodb --version 0.4.24`,
    },
    webDocs: {
