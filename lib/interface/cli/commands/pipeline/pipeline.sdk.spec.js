            ...
            describe('cf', () => {
                ...
                describe('run', () => {
                    it('should handle running pipeline with encrypted variables', async () => {
                        ...
                        _.set(
                            argv,
                            `${defaults.CLI_INTERNAL_CONFIG}.apiVersion`,
                            defaults.MIN_API_VERSION_FOR_ENCRYPTED_VARS_SUPPORT_IN_RUN_CMD
                        );
                    ...
                    it('should handle running pipeline with encrypted variables passing inside json file', async () => {
                        ...
                        _.set(argv, `${defaults.CLI_INTERNAL_CONFIG}.apiVersion`, defaults.MIN_API_VERSION_FOR_ENCRYPTED_VARS_SUPPORT_IN_RUN_CMD);
                        const pip = new CfPipeline(argv);
                        await pip.run();
                        expect(pip.executionRequests[0].options.variables).toEqual(
