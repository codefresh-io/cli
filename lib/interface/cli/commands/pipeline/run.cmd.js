...
const run = new Command({
    ...
    builder: (yargs) => {
        yargs
            ...
            .example('codefresh run PIPELINE_ID | PIPELINE_NAME -b=master -v key1=value1 -v key2=value2 -e key1', 'Setting variables through the command with encrypted variables')
