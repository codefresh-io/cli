...
const { prepareKeyValueFromCLIEnvOption,
    ...
    prepareKeyValueObjectsFromCLIEnvOption } = require('../../helpers/general');
...
class RunBaseCommand {
    ...
    async run() {
        ...
        const apiVersion = _.get(this.argv, `${defaults.CLI_INTERNAL_CONFIG}.apiVersion`);
        const encryptedVarsSupported = apiVersion && semver.gte(apiVersion, defaults.MIN_API_VERSION_FOR_ENCRYPTED_VARS_SUPPORT_IN_RUN_CMD);
