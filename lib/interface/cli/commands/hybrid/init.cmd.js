...
const { createErrorHandler, keyValueArrayToObject } = require('./helper');
        ...
        if (noQuestions) {
            ...
            if (httpProxy) {
                questions.push({
                    ...
                    name: 'httpProxy',
                    default: httpProxy,
                    message: 'detected HTTP_PROXY, should I set this for the Codefresh runner components?',
                });
            }
            ...
            if (httpsProxy) {
                questions.push({
                    ...
                    name: 'httpsProxy',
                    default: httpsProxy,
                    message: 'detected HTTPS_PROXY, should I set this for the Codefresh runner components?',
