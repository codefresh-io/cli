...
const initCmd = new Command({
    ...
    handler: async (argv) => {
        ...
        } else if (_.get(sdk, 'config.context.isNoAuth')) {
            console.log('Not authenticated as a Codefresh account: ');
            console.log('In order to install a Codefresh Runner you need to need to provide ' +
                `an authentication token which can be found here: ${colors.blue(`${argv.url}/user/settings`)}.` +
