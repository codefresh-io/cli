    ...
    handler: async (argv) => {
        ...
        installationPlan.addStep({
            ...
            func: async () => {
                ...
                if (dockerDaemonScheduler) {
                    const currentdockerDaemonScheduler = _.get(re, 'dockerDaemonScheduler', {});
                    const newDockerDaemonScheduler = _.merge(currentdockerDaemonScheduler, dockerDaemonScheduler);
            ...
            condition: envVars.length || reResources || dockerDaemonScheduler,
        });
