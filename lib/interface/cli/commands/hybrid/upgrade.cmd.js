    ...
    handler: async (argv) => {
        ...
        if (!runtimeName) {
            ...
            const answer = await inquirer.prompt({
                type: 'list',
                name: 'runtime',
                message: 'The runtimes that can be upgraded or migrated (if version is 0.x.x)',
...
`);
        ...
        console.log(`Successfully ${shouldDoMigration ? 'migrated' : 'upgraded'} your Codefresh Runner`);
