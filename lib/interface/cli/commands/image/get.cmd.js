...
const { prepareKeyValueFromCLIEnvOption, serializeObjectAsQueryParam } = require('../../helpers/general');
...
const command = new Command({
    ...
    handler: async (argv) => {
        ...
        if (!_.isEmpty(imageIds)) {
            ...
            images = await sdk.images.getAll({
                metadata: serializeObjectAsQueryParam(labels, 'metadata'),
                tag: tags,
                sha,
                limit,
                type,
