...
const untag = new Command({
    ...
    category: 'Images',
    description: 'Delete an image tag',
    ...
    builder: (yargs) => {
        yargs
            ...
            .example('codefresh untag 2dfacdaad466 1.0.0', "Delete tag '1.0.0' from image '2dfacdaad466'")
            .example('codefresh untag 2dfacdaad466 1.0.0 my-tag', "Delete tags '1.0.0' and 'my-tag' from image'2dfacdaad466'");
