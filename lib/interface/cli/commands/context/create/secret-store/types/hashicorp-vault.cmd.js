...
function buildAuthObject({ token, username, password, roleId, secretId, loginPath, gcpRoleType, gcpRole }) {
    ...
    if (gcpRoleType && gcpRole) {
        return { type: 'gcp', roleType: gcpRoleType, role: gcpRole, ...mountPoint };
    }
    ...
    builder(yargs) {
        return yargs
            ...
            .option('token', {
                ...
                describe: 'Token',
                type: 'string',
                conflicts: ['username', 'password', 'roleId', 'secretId', 'gcp-role-type', 'gcp-role'],
            })
            .option('username', {
                describe: 'Username',
                alias: 'u',
                type: 'string',
                conflicts: ['token', 'roleId', 'secretId', 'gcp-role-type', 'gcp-role'],
            })
            .option('password', {
                describe: 'Password',
                alias: 'p',
            ...
            .option('role-id', {
                ...
                alias: 'r',
                type: 'string',
                conflicts: ['token', 'username', 'password', 'gcp-role-type', 'gcp-role'],
            })
            .option('secret-id', {
                describe: 'Secret Id',
                alias: 's',
            ...
            .option('gcp-role-type', {
                describe: 'GCP Role Type',
                type: 'string',
                implies: 'behind-firewall',
                conflicts: ['token', 'username', 'password', 'role-id', 'secret-id'],
            })
            .option('role', {
                describe: 'GCP Role',
                type: 'string',
