...
const CodefreshRepo = require('../../../../logic/entities/CodefreshRepo');
...
const command = new Command({
    ...
    handler: async (argv) => {
        ...
        let ctxList = await sdk.contexts.getAll();
        ...
        const loadRepos = available ? sdk.repos.getAllGitRepos : sdk.repos.getAll;
        const filterProperty = available ? 'info.repo_shortcut' : 'info.serviceName';
        const Entity = available ? GitRepo : CodefreshRepo;
