...
const { INSTALLATION_DEFAULTS, installAppProxy, createErrorHandler } = require('../hybrid/helper');
...
const mergeWithValues = (argv) => {
    ...
    setIfNotDefined(argv, 'kube-namespace', valuesObj.Namespace);
    setIfNotDefined(argv, 'kube-context-name', valuesObj.Context);
...
const installAppProxyHandler = new Command({
    ...
    builder: yargs => yargs
        ...
        .option('kube-context-name', {
            describe: 'Name of the kubernetes context on which the app-proxy should be installed [$CF_ARG_KUBE_CONTEXT_NAME]',
            default: getKubeContext(),
        })
        .option('kube-namespace', {
            describe: 'Name of the namespace on which app-proxy should be installed [$CF_ARG_KUBE_NAMESPACE]',
