...
const handler = async (argv) => {
    ...
    if (owner === 'account') {
        await context.deleteAccountContextByName(name);
        console.log(`Account context: ${name} deleted`);
    } else if (owner === 'user') {
        await context.deleteUserContextByName(name);
        console.log(`User context: ${name} deleted`);
    } else {
