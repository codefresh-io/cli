...
const handler = async (argv) => {
    ...
    if (owner === 'account') {
        await context.replaceAccountContext(data);
        console.log(`Account context: ${name} replaced`);
    } else if (owner === 'user') {
        await context.replaceUserContext(data);
        console.log(`User context: ${name} replaced`);
    } else {
