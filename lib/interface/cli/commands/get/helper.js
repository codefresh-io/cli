...
const specifyOutputForSingle = (type , enitity) => {
    switch (type) {
        ...
        case 'name':
            ...
            break;
        case 'wide':
            _printInfoTable(enitity.toWide());
            break;
        default:
            _printInfoTable(enitity.toDefault());
    }
};
