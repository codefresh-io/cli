...
const {NoPropertyError, MultiplePropertiesError, NotFullPropertyError} = require('../../../logic/cli-config/errors');
...
function outputSingleOption(key, value) {
    console.log(columnify([{key, value}]));
}
