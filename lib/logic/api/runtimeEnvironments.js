...
const _extractFieldsForRuntimeEnvironmentEntity = runtimeEnv => _.pick(runtimeEnv, 'version', 'metadata', 'runtimeScheduler', 'dockerDaemonScheduler', 'history', 'extends', 'description', 'isPublic', 'isDefault', 'accountId', 'plan', 'accounts');
