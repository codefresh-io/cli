...
const getAll = async (sourceControl, pipelineName) => {
    const qs = {
 ...
 * @returns {Promise<*>}
 */
const getAllByRepo = async (repoOwner, repoName, sourceControl, pipelineName) => {
    const qs = {
        provider: sourceControl,
        name: pipelineName,
    };
 ...
 * @returns {Promise<*>}
 */
const getPipelineByNameAndRepo = async (name, repoOwner, repoName, sourceControl) => {
    const pipelines = await getAllByRepo(repoOwner, repoName, sourceControl);
