...
const getAll = async (provider, pipelineName) => {
    const qs = {
        provider: provider,
        name: pipelineName,
    };
 ...
 * @returns {Promise<*>}
 */
const getAllByRepo = async (repoOwner, repoName, provider, pipelineName) => {
    const qs = {
        provider: provider,
        name: pipelineName,
    };
 ...
 * @returns {Promise<*>}
 */
const getPipelineByNameAndRepo = async (name, repoOwner, repoName, provider) => {
    const pipelines = await getAllByRepo(repoOwner, repoName, provider);
